...
from custom.layers import FlattenLayer, VGGFCLowLayer, CustomPoolingOnlyConfidenceLayer, VGGFCNormalLayer
from custom.train_model import train_model
from models.yolo import Model

NAME = 'yoloGPVGG_c_Normal'
DEVICE = 'cuda:2'
INPUT_SIZE = 320
BATCH_SIZE = 32
...
def main():
    ...
    model = nn.Sequential(
        model,
        CustomPoolingOnlyConfidenceLayer(),
        VGGFCNormalLayer(_in=900),
    )
