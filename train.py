...
def parse_opt(known=False):
    ...
    parser.add_argument('--project', default=ROOT / 'custom_runs/train', help='save to project/name')
...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.resume and not check_wandb_resume(opt) and not opt.evolve:  # resume an interrupted run
        ...
        if opt.evolve:
            if opt.project == str(ROOT / 'custom_runs/train'):  # if default project name, rename to custom_runs/evolve
                opt.project = str(ROOT / 'custom_runs/evolve')
